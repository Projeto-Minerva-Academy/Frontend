  ...
  return (
    <section className="py-28 bg-white">
      <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
        <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
          ...
          <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
            ...
            <a
              href="/Cadastrar"
              className="flex items-center justify-center gap-x-2 py-2 px-4 text-white bg-blue-400 hover:text-black font-medium duration-150 active:bg-gray-100 border border-blue-400 rounded-lg md:inline-flex"
            >
      ...
      <div className="mt-14 px-4 md:px-8">
        <p className="text-center md: text-2xl text-gray-700 font-semibold">
